    ...
    <div className="space-y-8">
      <section className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
        ...
        <div className="flex gap-4 mt-6">
          <Link href="/rides" className="px-4 py-2 rounded-lg font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 bg-blue-600 text-white hover:bg-blue-700 focus:ring-blue-500">
            Browse Rides
          </Link>
          <Link href="/my-rides" className="px-4 py-2 rounded-lg font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 bg-gray-200 text-gray-800 hover:bg-gray-300 focus:ring-gray-400">
            Create Ride
          </Link>
          <Link href="/login" className="px-4 py-2 rounded-lg font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 bg-gray-200 text-gray-800 hover:bg-gray-300 focus:ring-gray-400">
            Sign In
          </Link>
        </div>
      </section>
